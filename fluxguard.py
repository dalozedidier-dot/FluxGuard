...
# Bootstrap: rend les imports fiables quel que soit le répertoire d'exécution.
...
def utc_timestamp() -> str:
    """
    Timestamp utile pour traçabilité.
    Reproductible si SOURCE_DATE_EPOCH est défini.
    """
